  ...
  try {
    ...
    if (process.env.GEMINI_API_KEY) {
      try {
        ...
        let ruleInstruction = "";
        if (isFirstDay) {
          ruleInstruction = "นี่คือวันแรกของทริป: กิจกรรมเริ่มจากการเดินทาง (สนามบินสุวรรณภูมิ, เที่ยวบิน, ผ่านตม., รับสัมภาระ, เข้าสู่ที่พัก) หากเวลาไฟลท์เอื้ออำนวยสามารถใส่สถานที่ท่องเที่ยวหรือถนนคนเดินยามค่ำคืนที่เป็นสถานที่จริง 1 แห่งได้";
        } else if (isLastDay) {
          ruleInstruction = "นี่คือวันสุดท้ายของทริป: กิจกรรมการเดินทางกลับ (รับประทานอาหารเช้า, เช็คเอาท์โรงแรม, ช้อปปิ้งของฝากหรือแวะแลนด์มาร์กใกล้สนามบินช่วงเช้า, เดินทางสู่สนามบิน, เช็คอินโหลดสัมภาระ, บินกลับกรุงเทพฯ)";
        } else {
          ruleInstruction = "นี่คือวันระหว่างทริป: ต้องระบุสถานที่ท่องเที่ยวจริง แลนด์มาร์กสำคัญ และร้านอาหารจริงในเมืองนั้น ห้ามใช้คำกว้างๆ หรือ placeholder เช่น 'แลนด์มาร์กอันดับ 1' หรือ 'ย่านครีเอทีฟ' เด็ดขาด ทุกกิจกรรมต้องมีชื่อสถานที่จริง (ชื่อไทย + อังกฤษ)";
        }
