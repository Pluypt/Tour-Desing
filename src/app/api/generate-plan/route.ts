...
3. วันระหว่างทริป (Day 2 ถึง Day ${duration - 1}): สกัดแลนด์มาร์กใหม่ มุมถ่ายรูปยอดฮิต คาเฟ่ aesthetic จุดเช็คอินยอดนิยมและสถาปัตยกรรมโดดเด่นที่เป็นของจริงในเมืองนั้น มีเน้นตัวหนา **[ชื่อสถานที่]**
